...
import { sendVideoInProcess } from "../../../queue/index.js";
...
class VideoService {
  static videoTranscode = async (videoObject, files) => {
    ...
    await sendVideoInProcess(videoData);
    ...
    return responses.success("down to convert it", video);
  };
